...
(() => {
  ...
  document.getElementById('btn-download-pdf')?.addEventListener('click', () => {
    try {
      ...
      // Title + Summary
      y = 72; doc.setTextColor(17,24,39); doc.setFontSize(20); doc.setFont('helvetica','bold'); line(sop.title || 'Untitled SOP');
      if (sop.summary) { y += 6; doc.setFont('helvetica','normal'); doc.setFontSize(12); doc.setTextColor(55,65,81); line(sop.summary); y += 6; }
